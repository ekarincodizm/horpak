...
--
-- Host: localhost
-- Generation Time: Mar 27, 2016 at 06:27 PM
...
CREATE TABLE IF NOT EXISTS `m_config` (
  ...
  `horpak_id` int(11) NOT NULL,
  `tax_rate` double NOT NULL,
  `elec_rate` double NOT NULL,
...
INSERT INTO `m_config` (`code_id`, `horpak_id`, `tax_rate`, `elec_rate`, `water_rate`, `last_update`, `update_by`) VALUES
(35, 26, 54545, 4545, 4545, '0000-00-00 00:00:00', 4545),
(33, 323, 2323, 2323, 2323, '0000-00-00 00:00:00', 23),
(30, 3232, 32323, 323, 232, '0000-00-00 00:00:00', 232323),
(36, 23, 0, 0, 0, '0000-00-00 00:00:00', 0),
(34, 23, 333, 333, 333, '0000-00-00 00:00:00', 333),
(37, 24, 3, 3, 3333, '0000-00-00 00:00:00', 3);

-- --------------------------------------------------------

--
-- Table structure for table `m_label`
--

CREATE TABLE IF NOT EXISTS `m_label` (
  `code_id` int(11) NOT NULL AUTO_INCREMENT,
  `c_group` varchar(50) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `c_label` varchar(100) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `c_value` varchar(100) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `order_by` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`code_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=14 ;

--
-- Dumping data for table `m_label`
--

INSERT INTO `m_label` (`code_id`, `c_group`, `c_label`, `c_value`, `order_by`) VALUES
(2, 'ROOM_STATUS', 'ถูกจอง', '1', 1),
(3, 'ROOM_STATUS', 'เข้าอยู่แล้ว', '2', 2),
(4, 'ROOM_STATUS', 'แจ้งออก', '3', 3),
(5, 'SERVICE_STATUS', 'ปรกติ', '1', 1),
(6, 'SERVICE_STATUS', 'ยกเลิกการขาย', '2', 2),
(9, 'SERVICE_STATUS', 'ห้องนอนเต็ม', '9', 9);
...
CREATE TABLE IF NOT EXISTS `m_room` (
  ...
  `room_status` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `room_desc` text COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`code_id`)
...
INSERT INTO `m_room` (`code_id`, `horpak_id`, `type_id`, `room_no`, `floor`, `price`, `room_status`, `room_desc`) VALUES
(1, 27, 6, '1', 1, 1, '4', '111'),
(3, 27, 9999, '9999', 9999, 9999, '3', '9999'),
(4, 27, 12, '998', 4, 5000, '2', '1'),
(5, 23, 111, '111', 222, 111, '4', '1112'),
(6, 24, 2, '599', 599, 599, '3', '599'),
(7, 23, 2, '11111', 11111, 11111, '2', '11111'),
(8, 24, 2, '55555', 55555, 55555, '3', '55555'),
(9, 24, 4, '23333', 23333, 23333, '3', '23333'),
(10, 25, 2, '4444', 4444, 4444, '3', '4444');

-- --------------------------------------------------------

--
-- Table structure for table `m_room_type`
--
...
CREATE TABLE IF NOT EXISTS `m_room_type` (
  ...
  `type_desc` text COLLATE utf8_unicode_ci NOT NULL,
  `std_price` double NOT NULL,
  PRIMARY KEY (`code_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=8 ;

--
-- Dumping data for table `m_room_type`
--

INSERT INTO `m_room_type` (`code_id`, `horpak_id`, `type_name`, `type_desc`, `std_price`) VALUES
(4, 23, 'ห้อง VIP', '5999', 5999),
(2, 23, 'ห้อง Music', 'ห้อง Music', 5999),
(6, 23, 'สุขา', 'สุขา', 2990),
(7, 24, 'ห้องครัว', 'ห้องครัว', 1999);
...
CREATE TABLE IF NOT EXISTS `m_service` (
  ...
  `sercice_desc` text COLLATE utf8_unicode_ci NOT NULL,
  `price` double NOT NULL,
  `service_status` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`code_id`)
...
INSERT INTO `m_service` (`code_id`, `horpak_id`, `service_name`, `sercice_desc`, `price`, `service_status`) VALUES
(1, 24, 'นวด', 'นวด', 500, '1'),
(2, 24, 'ล้างหน้าด้วยฝ่าเท้า', 'ล้างหน้าด้วยฝ่าเท้า', 5, '5'),
(3, 23, 'ล้างห้องน้ำ', '', 9999, '99999');
...
INSERT INTO `p_customer` (`code_id`, `horpak_id`, `fname`, `lname`, `id_card`, `birth_day`, `addr`, `city`, `state`, `province`, `zipcode`, `email`, `mobile`, `avatar`) VALUES
(1, 11, '111', '11', '11', '0000-00-00', '111', '111', '111', '111', '11', '1111', '111', '111'),
(2, 3333, '33333', '3333', '333', '0000-00-00', '333', '333', '333', '333', '333', '333', '', '333'),
(3, 3333, '111', '111', '1111', '0000-00-00', '111', '2222', '111', '1111', '2222', '2222', '3333', '333'),
(4, 11111, '1', '1', '1', '0000-00-00', '1', '6113', '685', '47', '60120', '111@f.com', '111111', '111111'),
(5, 11111, '1', '1', '1', '0000-00-00', '1', '6113', '685', '47', '60120', '111@f.com', '111111', '111111'),
(6, 121212, 'pool', 'pool', 'pool', '0000-00-00', 'pool', '7023', '783', '56', '71150', 'pool@gmail.com', '12121', '121212');

-- --------------------------------------------------------

--
-- Table structure for table `p_horpak`
--

CREATE TABLE IF NOT EXISTS `p_horpak` (
  `code_id` int(11) NOT NULL AUTO_INCREMENT,
  `name_th` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `name_en` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `addr_th` text COLLATE utf8_unicode_ci NOT NULL,
  `addr_en` text COLLATE utf8_unicode_ci NOT NULL,
  `city` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `state` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `province` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `zipcode` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `p_horpak`
--

INSERT INTO `p_horpak` (`code_id`, `name_th`, `name_en`, `addr_th`, `addr_en`, `city`, `state`, `province`, `zipcode`, `phone`, `email`, `contact`, `desc_th`, `desc_en`, `join_date`) VALUES
(23, 'หอพักอางทอง', 'angtong', 'ซอยวิเชียร', 'ซอยวิเชียร', '1', '2', '3', '4', '1', '2', '3', '4', '5', '2016-03-27 00:00:00'),
(24, 'นรินหอพัก', 'angtong', 'ซอยวิเชียร', 'ซอยวิเชียร', '1', '2', '3', '4', '1', '2', '3', '4', '5', '2016-03-27 00:00:00'),
(25, 'thaismilesoft.com@gmail.com', 'thaismilesoft.com@gmail.com', 'thaismilesoft.com@gmail.com', 'thaismilesoft.com@gmail.com', '4680', '515', '34', '46110', '0800000000', 'thaismilesoft.com@gmail.com', 'thaismilesoft.com@gmail.com', 'thaismilesoft.com@gmail.com', 'thaismilesoft.com@gmail.com', '2016-03-27 00:00:00'),
(26, 'หอพักระยอง', 'หอพักระยอง', 'หอพักระยอง', 'หอพักระยอง', '15', '2', '1', '10300', '0800000000', 'rayong@fmailc.com', 'หอพักระยอง', 'หอพักระยอง', 'หอพักระยอง', '2016-03-27 00:00:00'),
(27, 'พอพักสะพานควาย', 'พอพักสะพานควาย', 'พอพักสะพานควาย', 'พอพักสะพานควาย', '7030', '784', '56', '71160', '0800000000', 'thaismilesoft.com@gmail.com', 'พอพักสะพานควาย', 'พอพักสะพานควาย', 'พอพักสะพานควาย', '2016-03-27 00:00:00');
...
INSERT INTO `p_user` (`code_id`, `user_name`, `user_pass`, `fb_id`, `customer_id`, `horpak_id`, `user_type`, `user_level`, `join_date`, `user_status`) VALUES
(1, 'admin', '1234', '*', 1, 1, '1', '1', '2016-03-10 00:00:00', '1');
...
CREATE TABLE IF NOT EXISTS `t_bill` (
  ...
  `room_mny` double NOT NULL,
  `service_mny` double NOT NULL,
  `water_mny` double NOT NULL,
  `elec_mny` double NOT NULL,
  `tax_mny` double NOT NULL,
  `discount_mny` double NOT NULL,
  `tot_mny` double NOT NULL,
  `debt_mny` double NOT NULL,
  `bill_content` text COLLATE utf8_unicode_ci NOT NULL,
  `tax_conf_ref` double NOT NULL,
  `open_id_ref` int(11) NOT NULL,
  `meter_ref` int(11) NOT NULL,
  `t_service_ref` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `create_date` datetime NOT NULL,
  `create_by` int(11) NOT NULL,
  `bill_status` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `payment_du_date` date NOT NULL,
...
--
-- Table structure for table `t_cal_meter`
--

CREATE TABLE IF NOT EXISTS `t_cal_meter` (
  `code_id` int(11) NOT NULL AUTO_INCREMENT,
  `horpak_id` int(11) NOT NULL,
  `room_id` int(11) NOT NULL,
  `elec_from_id` int(11) NOT NULL,
  `water_from_id` int(11) NOT NULL,
  `elec_to_id` int(11) NOT NULL,
  `water_to_id` int(11) NOT NULL,
  `conf_elec` double NOT NULL,
  `conf_water` double NOT NULL,
  `price_elec` double NOT NULL,
...
CREATE TABLE IF NOT EXISTS `t_inv` (
  `code_id` int(11) NOT NULL AUTO_INCREMENT,
  `horpak_id` int(11) NOT NULL,
  `room_id` int(11) NOT NULL,
  `bill_id` int(11) NOT NULL,
  `rec_mny` double NOT NULL,
  `create_date` datetime NOT NULL,
  `create_by` int(11) NOT NULL,
  `remark` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `open_id_ref` int(11) NOT NULL,
...
--
-- Table structure for table `t_meter_record`
--

CREATE TABLE IF NOT EXISTS `t_meter_record` (
  `code_id` int(11) NOT NULL,
  `horpak_id` int(11) NOT NULL,
  `room_id` int(11) NOT NULL,
  `record_type` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `meter_record` int(11) NOT NULL,
  `create_date` datetime NOT NULL,
  `create_by` int(11) NOT NULL,
  `open_id_ref` int(11) NOT NULL,
  PRIMARY KEY (`code_id`)
...
--
-- Table structure for table `t_room_open`
--

CREATE TABLE IF NOT EXISTS `t_room_open` (
  `code_id` int(11) NOT NULL AUTO_INCREMENT,
  `horpak_id` int(11) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `room_id` int(11) NOT NULL,
  `adv_mny` double NOT NULL,
  `ins_mny` double NOT NULL,
  `eff_date` datetime NOT NULL,
  `end_date` datetime NOT NULL,
  `open_status` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `t_service_use`
--

CREATE TABLE IF NOT EXISTS `t_service_use` (
  `code_id` int(11) NOT NULL AUTO_INCREMENT,
  `horpak_id` int(11) NOT NULL,
  `room_id` int(11) NOT NULL,
...
--
-- Table structure for table `u_amphur`
--

CREATE TABLE IF NOT EXISTS `u_amphur` (
...
--
-- Dumping data for table `u_amphur`
--

INSERT INTO `u_amphur` (`amphur_id`, `amphur_code`, `amphur_name`, `postcode`, `geo_id`, `province_id`) VALUES
...
--
-- Table structure for table `u_district`
--

CREATE TABLE IF NOT EXISTS `u_district` (
...
--
-- Dumping data for table `u_district`
--

INSERT INTO `u_district` (`district_id`, `district_code`, `district_name`, `amphur_id`, `province_id`, `geo_id`) VALUES
...
--
-- Table structure for table `u_geography`
--

CREATE TABLE IF NOT EXISTS `u_geography` (
...
--
-- Dumping data for table `u_geography`
--

INSERT INTO `u_geography` (`geo_id`, `geo_name`) VALUES
(1, 'ภาคเหนือ'),
(2, 'ภาคกลาง'),
...
--
-- Table structure for table `u_province`
--

CREATE TABLE IF NOT EXISTS `u_province` (
...
--
-- Dumping data for table `u_province`
--

INSERT INTO `u_province` (`province_id`, `province_code`, `province_name`, `geo_id`) VALUES
